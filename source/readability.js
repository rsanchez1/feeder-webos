...
var readability = {
    ...
    init: function(doc) {
        ...
        if(readability.contentToParse && !readability.bodyCache) {
            readability.bodyCache = readability.contentToParse.innerHTML;
        ...
        var nextPageLink = readability.findNextPageLink(readability.contentToParse);
        
        readability.prepDocument();
        enyo.log("prepped page");
	...
	enyo.log('appended children');
        /* Clear the old HTML, insert the new content. */
        readability.contentToParse.innerHTML = "";
        readability.contentToParse.insertBefore(overlay, readability.contentToParse.firstChild);
        //document.body.removeAttribute('style');
	enyo.log('updated page');
	...
	enyo.log("post processed content");
    ...
    **/
    ...
    getArticleTitle: function () {
        ...
        try {
            ...
            //if(typeof curTitle !== "string") { /* If they had an element with id "title" in their HTML */
                curTitle = origTitle = readability.getInnerText(readability.contentToParse.getElementsByTagName('title')[0]);             
            //}
        }
        catch(e) {}
        ...
        {
            var hOnes = readability.contentToParse.getElementsByTagName('h1');
            if(hOnes.length === 1)
            {
    ...
    prepDocument: function () {
		...
		*/
        ...
        readability.contentToParse.firstChild.id = "readabilityBody";

        var frames = readability.contentToParse.getElementsByTagName('frame');
        if(frames.length > 0)
        {
            var bestFrame = null;
            ...
            if(bestFrame)
            {
                ...
                var frameset = readability.contentToParse.getElementsByTagName('frameset')[0];
                if(frameset) {
		...
		*/
        ...
        var styleTags = readability.contentToParse.getElementsByTagName("style");
        ...
        readability.contentToParse.innerHTML = readability.contentToParse.innerHTML.replace(readability.regexps.replaceBrs, '</p><p>').replace(readability.regexps.replaceFonts, '<$1span>');
    },
    ...
    **/
    grabArticle: function (page) {
        ...
        page = page ? page : readability.contentToParse;
    ...
    **/
    cleanStyles: function (e) {
        e = e || readability.contentToParse.firstChild;
    ...
    **/
    ...
    emailBox: function () {
		...
		readability.contentToParse.appendChild(emailContainer);
    },
